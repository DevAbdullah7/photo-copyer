...
count = int(input('How much of copy do you need? '))
copy_file = input('Enter Hardisk: ')+':\\\\Users\\\\'+input('Enter user name: ')+'\\\\'+input('whare is the File? ')+'\\\\'+input('Enter File name: ')+'\\\\' * count
